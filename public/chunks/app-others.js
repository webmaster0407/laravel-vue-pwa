...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_13__.mapGetters)(['subscriptionTypes', 'config'])),
  data: function data() {
    return {
      isLoading: true,
  ...
  methods: {
    ...
    flushCache: function flushCache() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_8___default().get('/api/admin/settings/flush-cache').then(function () {
        _bus__WEBPACK_IMPORTED_MODULE_7__.events.$emit('toaster', {
          type: 'success',
