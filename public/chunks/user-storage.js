...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _components_UI_ProgressChart_ProgressLine__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../components/UI/ProgressChart/ProgressLine */ "./resources/js/components/UI/ProgressChart/ProgressLine.vue");
...
/* harmony import */ var _components_UI_BarChart_BarChart__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../../components/UI/BarChart/BarChart */ "./resources/js/components/UI/BarChart/BarChart.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  props: ['user'],
  components: {
    ProgressLine: _components_UI_ProgressChart_ProgressLine__WEBPACK_IMPORTED_MODULE_0__["default"],
    ...
    BarChart: _components_UI_BarChart_BarChart__WEBPACK_IMPORTED_MODULE_7__["default"]
  },
  ...
  methods: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                axios__WEBPACK_IMPORTED_MODULE_9___default().post(_this.$store.getters.api + '/admin/users/' + _this.$route.params.id + '/capacity', {
                  attributes: {
    ...
    getStorageDetails: function getStorageDetails() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default().get('/api/admin/users/' + this.$route.params.id + '/storage').then(function (response) {
