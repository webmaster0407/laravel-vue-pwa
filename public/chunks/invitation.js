...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    acceptInvitation: function acceptInvitation() {
      ...
      this.isLoading = true;
      axios__WEBPACK_IMPORTED_MODULE_7___default().put("/api/teams/invitations/".concat(this.$router.currentRoute.params.id)).then(function () {
    ...
    declineInvitation: function declineInvitation() {
      ...
      this.isLoading = true;
      axios__WEBPACK_IMPORTED_MODULE_7___default()["delete"]("/api/teams/invitations/".concat(this.$router.currentRoute.params.id)).then(function () {
  ...
  created: function created() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_7___default().get("/api/teams/invitations/".concat(this.$router.currentRoute.params.id)).then(function (response) {
