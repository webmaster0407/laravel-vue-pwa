...
/* harmony import */ var _components_UI_Others_InfoBox__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../components/UI/Others/InfoBox */ "./resources/js/components/UI/Others/InfoBox.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    InfoBox: _components_UI_Others_InfoBox__WEBPACK_IMPORTED_MODULE_1__["default"],
  ...
  computed: _objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_11__.mapGetters)(['roles', 'config'])),
  data: function data() {
    return {
      isLoading: false,
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                axios__WEBPACK_IMPORTED_MODULE_8___default().post(_this.$store.getters.api + '/admin/users/' + _this.$route.params.id + '/role', {
                  attributes: {
                    role: _this.userRole
                  },
                  _method: 'patch'
