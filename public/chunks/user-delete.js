          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 8:
                ...
                axios__WEBPACK_IMPORTED_MODULE_7___default().post(_this.$store.getters.api + '/admin/users/' + _this.$route.params.id, {
                  name: _this.userName,
                  _method: 'delete'
                  ...
                  if (response.status === 200) {
                    _bus__WEBPACK_IMPORTED_MODULE_6__.events.$emit('success:open', {
                      emoji: '👍',
